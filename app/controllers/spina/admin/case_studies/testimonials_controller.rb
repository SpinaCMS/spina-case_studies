module Spina::Admin
  class CaseStudies::TestimonialsController < AdminController
    ...
    def destroy
      @testimonial = Spina::CaseStudies::CaseStudy.find params[:id]
      @testimonial.destroy
      redirect_to spina.admin_case_studies_testimonials_path, notice: t('spina.case_studies.testimonials.destroyed')
    end

    private

    def set_breadcrumb
      add_breadcrumb I18n.t('spina.case_studies.testimonials.title'), spina.admin_case_studies_testimonials_path
    end
    ...
    def resource_params
      params.require(:testimonial).permit(:name, :company, :job_title, :content, :spina_photo_id)
    end
